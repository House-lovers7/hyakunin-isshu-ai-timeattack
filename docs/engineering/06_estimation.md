...
# _starter_nextjs — 見積り（オンボーディング・契約確認）
...
| データ契約確認（1 entity） | 2h | 4h | `src/lib/db/schema.ts` | field/relation/constraint/migrationを確認 |
| 画面状態確認（1 screen） | 2h | 4h | `src/app/page.tsx` | 主要状態と導線をsmoke/testで確認 |
